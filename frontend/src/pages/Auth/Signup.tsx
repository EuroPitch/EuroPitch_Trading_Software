...
export default function Signup() {
  ...
  const validateStep2 = () => {
    ...
    for (let i = 0; i < 4; i++) {
      ...
      if (!participant.email)
        ...
        !/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i.test(participant.email)
      )
    ...
    for (let i = 4; i < 6; i++) {
      ...
      if (hasAnyField) {
        if (!participant.firstName.trim())
          newErrors[`participant${i}FirstName`] =
            "First name is required if adding participant";
        if (!participant.lastName.trim())
          newErrors[`participant${i}LastName`] =
            "Last name is required if adding participant";
        if (!participant.email)
          newErrors[`participant${i}Email`] =
            "Email is required if adding participant";
        else if (
          !/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i.test(participant.email)
        )
          newErrors[`participant${i}Email`] = "Invalid email address";
  ...
  const handleParticipantChange = (
    ...
    const errorKey = `participant${index}${
          ...
          {step === 1 && (
            <form className="auth-form">
              ...
              <div className="form-group">
                ...
                <p className="field-hint">
                  Only European countries are eligible
                </p>
              </div>
            ...
            <form onSubmit={handleSubmit} className="auth-form">
              <div className="team-section">
                ...
                <p className="section-description">
                  Enter details for your team members. First 4 are required,
                  last 2 are optional.
                </p>
